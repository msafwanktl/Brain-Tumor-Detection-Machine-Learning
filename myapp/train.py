...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--image_dir',
        type=str,
        default='C:\\Users\\MSA\\Downloads\\New folder\\brain tumor file1\\brain-tumor-mri-dataset\\',
    ...
    parser.add_argument(
        '--summaries_dir',
        type=str,
        default='C:\\Users\\MSA\\Downloads\\New folder\\brain tumor file1\\retrain_new_logs',
    ...
    parser.add_argument(
        '--model_dir',
        type=str,
        default='C:\\Users\\MSA\\Downloads\\New folder\\brain tumor file1',
        help="""\
